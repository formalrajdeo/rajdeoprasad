export const PERSONAL_DATA = {
    EMPLOYEE: [
        {
            ...
            role_description: `I spearheaded critical projects such as HDFC ERGO's Pehchaan and Claim Status applications. Pehchaan aimed to streamline digital KYC processes, while Claim Status enabled users to efficiently check their claim status and download necessary documents. Leveraging cutting-edge technologies including Node.js, PostgreSQL, Express.js, and AWS services such as EC2 and S3, I played a pivotal role in delivering robust and scalable solutions. 
    ...
    EDUCATION: [
        {
            degree: 'Postgraduate',
            college_name: 'MCA, Mumbai University',
            from_date: '2018',
            to_date: '2021'
        },
        {
            degree: 'Undergraduate',
            college_name: 'BSc IT, Mumbai University',
            from_date: '2015',
            to_date: '2018'
        }
    ],
    ...
    SKILLS: [
        ...
        {
            title: 'DevTools and Other Skills',
            value: [
                {
                    name: 'Docker',
                    rating: 4
